...
注意：
此 task 依赖服务端支持嵌套 jsonschema 定义，几乎只有 openai 自己实现了嵌套 jsonschema，比如 llama.cpp / llm-studio 都是不支持这个功能的。
...
```json
{
  ...
  "children": [
    ...
    },
    {
      ...
      "children": [],
      "attributes": [
        { "name": "onClick", "value": "handleLogin()" },
        { "name": "className", "value": "btn btn-primary" }
      ]
    }
  ],
  "attributes": []
